...
//								If a datasource is opened in APPEND node, then the first write will take place starting
...
//			position(long) -	sets the channel's position to the passed valued.
...
//			ByteBusprintln("int3 = " + readBuffer.getInt());
